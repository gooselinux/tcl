...
%changelog
* Wed Jun 09 2010 Jaroslav Škarvada <jskarvad@redhat.com> - 1:8.5.7-6
- Reverted back tk paths (#596363)

* Tue Feb 0 2010 Nikola Pajkovsky <npajkovs@redhat.com> - 1:8.5.7-5
- Resolves: 557468. fix sigabort patch(add +1 to length)

* Mon Nov 30 2009 Dennis Gregorovic <dgregor@redhat.com> - 1:8.5.7-4.1
- Rebuilt for RHEL 6
